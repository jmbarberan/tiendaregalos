  ...
  <?php include("./layouts/header.php"); ?> 
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="h3 mb-3 text-black">Para contactarnos, por favor rellenar el formulario</h2>
          </div>
          <div class="col-md-7">
              ...
              <div class="p-3 p-lg-5 border">
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    ...
                    <input type="email" class="form-control" id="c_email" name="correo" placeholder="" required="">
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="c_message" class="text-black">Mensaje </label>
                    <textarea name="mensaje" id="c_message" cols="30" rows="7" class="form-control" required=""></textarea>
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-lg-12">
          ...
          <div class="col-md-5 ml-auto">
            <div class="p-4 border mb-3">
              <span class="d-block text-primary h6 text-uppercase">Ecuador/Guayaquil</span>
              <p class="mb-0">Guasmo Sur Coop. Unión de Bananeros Bloque 2 Mz. 16 Solar 29</p>
            </div>
          </div>
        </div>
      </div>
